    ...
    <div className="pl-[54px] group relative">
      ...
      {isEditing && !preview ? (
        <TextareaAutosize
          ...
          className="text-5xl bg-transparent font-bold break-words outline-none text-[#3f3f3f] dark:text-[#cfcfccf] resize-none"
        />
      ) : (
        <div
          onClick={enableInput}
          className="pb-[11.5px] text-5xl font-bold break-words outline-none text-[#3f3f3f] dark:text-[#cfcfccf]"
        >
          {initialData.title}
        </div>
      )}
